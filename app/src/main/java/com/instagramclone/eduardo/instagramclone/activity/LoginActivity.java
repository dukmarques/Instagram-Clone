...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Verifica sejá existe um usuário logado
    ...
    private void inicializarComponentes(){
        ...
        campoEmail.requestFocus(); //Foco será aplicado no campo e-mail, assim quando abrir a tela ja vai estar selecionado esta caixa de texto
    }
}